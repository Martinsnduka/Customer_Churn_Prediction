...
1. Which customers are at the highest risk of leaving?
2. What customer profile signals imminent churn?
...
##  Key Takeaways
1. Customers on **month-to-month contracts** with **short tenure** and **high monthly charges** are the most likely to churn.A strong churn signal **short-term contracts** tend to have higher churn rates.
2. The Random Forest model with **97% accuracy** gives the business a highly reliable tool for churn prediction.

**Martins Nduka**
- Data Analyst | Data Scientist
- [Gmail] ndukamartins2019@gmail.com | [LinkedIn](https://linkedin.com/in/martins-nduka-122x) |
